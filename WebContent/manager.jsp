    ...
    $(function () {    	
        ...
        $("#goto").click(function () {
            ...
            if(gotoPage ==""||gotoPage<=0||gotoPage>maxPage){
                ...
                location.href="${pageContext.request.contextPath }/manager/homeCostServlet?action=list&currentPage="+gotoPage+"&pageSize="+pageSize;
            }
        });
        ...
        $("#pagesize").change(function(){
        	...
        	location.href="${pageContext.request.contextPath }/manager/homeCostServlet?action=list&currentPage=1&pageSize="+pageSize;
		});
    });
    function showList() {
		...
		<table style="margin-top: 30px">
			...
			<c:forEach items="${requestScope.pageBean.getList()}" var="item">
				<tr>
					...
					<td>${item.sum}</td>
					<td><a 
						href="${pageContext.request.contextPath }/manager/homeCostServlet?action=showDetails&id=${item.id}">详情信息</a></td>
					<td><a
				...
				<td colspan="6">
					<div style="line-height: 20px; height: 20px;">
						...
						<c:if test="${pageBean.currentPage!=1}">
		    				[<a href="${pageContext.request.contextPath }/manager/homeCostServlet?action=list&currentPage=${pageBean.currentPage-1}&pageSize=${pageBean.pageSize}">
		    					前一页
							</a>]
						</c:if>
